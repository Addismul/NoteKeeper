...
//        mNote = intent.getParcelableExtra(NOTE_POSITION);
        mNotePostion = intent.getIntExtra(NOTE_POSITION, POSITION_NOT_SET);
        mIsNewNote = mNotePostion ==POSITION_NOT_SET ;
        if(mIsNewNote){
            createNewNote();
        }
        else
    ...
    protected void onPause() {
        ...
        if(mIsCanceling){
            Log.i(TAG,"Canceling note at position "+mNotePosition);
            if(mIsNewNote) DataManager.getInstance().removeNote(mNotePosition);
    ...
    private void sendEmail() {
        ...
        String text="Check Out what i learnt from Plular sight Course\"" +
